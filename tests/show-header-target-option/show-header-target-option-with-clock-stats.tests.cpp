...
TEST_CASE("'TRACE_OUT_SHOW_HEADER_TARGET' with '$clock_stats(...)'", "[TRACE_OUT_SHOW_HEADER_TARGET][clock_stats]")
{
	...
	REQUIRE_THAT(test::out_stream.str(), Matches(
		R"=(#### \[ [0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2} show-header-target-option-with-clock-stats-tests \] ####\n)="
		R"=(\n)="
