...
TEST_CASE("'TRACE_OUT_SHOW_HEADER_TARGET' with '$m(...)'", "[TRACE_OUT_SHOW_HEADER_TARGET][m]")
{
	...
	REQUIRE_THAT(test::out_stream.str(), Matches(
		R"=(#### \[ [0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}:[0-9]{2} show-header-target-option-with-m-tests \] ##\n)="
		R"=(\n)="
